...
const HEADER=`<header class="topbar"><div class="container nav"><a class="brand" href="index.html" aria-label="BuccalCare AI Home"><span class="logo">${ICONS.scan}</span><span class="brand-copy"><strong>BuccalCare <em>AI</em></strong></span></a><nav class="navlinks" id="navlinks" aria-label="Primary navigation"><a data-nav="home" href="index.html">${I('home')}<span>Home</span></a><a data-nav="screening" href="screening.html">${I('scan')}<span>AI Screening</span></a><a data-nav="results" href="results.html">${I('result')}<span>Results</span></a>${I('doctor')}</a><a data-nav="dashboard" href="dashboard.html">${I('dashboard')}<span>Dashboard</span></a><a data-nav="history" href="history.html">${I('history')}<span>History</span></a><a data-nav="how" href="how-it-works.html">${I('info')}<span>How It Works</span></a><a data-nav="about" href="about.html">${I('info')}<span>About</span></a></nav><div class="nav-actions"><button class="dark-toggle" id="themeBtn" type="button">${ICONS.moon}<span>Dark</span></button></div></div></header>`;
